...
final class ManagingFieldAccessReviewValidatorTest extends TestCase
{
    ...
    {
        self::assertTrue($this->validator()->isManagingFieldAccessReview(
            ManagingFieldPermissionVocabulary::FIELD_CONFIGURE,
            'component:managing',
            'permission.revoke',
            [],
        ));
    ...
    private function validator(): ManagingFieldAccessReviewValidator
    {
        return new ManagingFieldAccessReviewValidator();
    }
}
