 ...
 */
final readonly class ManageRollingBackedAccessReadinessReport
{
    /** @param list<ManageRollingBackedAccessReadinessItem> $items */
    ...
    public function toSafeArray(): array
    {
        return [
            ...
            'items' => array_map(
                static fn (ManageRollingBackedAccessReadinessItem $item): array => $item->toSafeArray(),
                $this->items,
            ),
            'safety' => [
                'read_only' => true,
