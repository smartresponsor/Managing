 ...
 */
abstract class ManageContentCrudController extends AbstractCrudController
{
    ...
    public function publish(AdminContext $context, ManagePublicationRepositoryInterface $publicationRepository): Response
    {
    ...
    /** @param AdminContext<TEntity> $context */
    public function unpublish(AdminContext $context, ManagePublicationRepositoryInterface $publicationRepository): Response
    {
        $this->publicationWorkflow()->setCurrentEntityPublicationState(
            $context,
            $publicationRepository,
    ...
    public function batchPublish(BatchActionDto $batchActionDto, ManagePublicationRepositoryInterface $publicationRepository, RequestStack $requestStack): Response
    {
    ...
    /** @param BatchActionDto<TEntity> $batchActionDto */
    public function batchUnpublish(BatchActionDto $batchActionDto, ManagePublicationRepositoryInterface $publicationRepository, RequestStack $requestStack): Response
    {
        $this->publicationWorkflow()->setBatchPublicationState(
            $batchActionDto,
            $publicationRepository,
