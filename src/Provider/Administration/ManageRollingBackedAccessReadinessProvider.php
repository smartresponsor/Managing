...
use App\Managing\ServiceInterface\Administration\ManageRollingBackedAccessReadinessProviderInterface;
use App\Managing\Value\Administration\ManageRollingBackedAccessReadinessItem;
 ...
 */
final readonly class ManageRollingBackedAccessReadinessProvider implements ManageRollingBackedAccessReadinessProviderInterface
{
    ...
    {
        return new ManageRollingBackedAccessReadinessReport(
            mode: 'rolling',
            failureEffect: 'deny',
    ...
    private function item(string $key, string $label, string $status, string $owner, string $expectedValue, string $note): ManageRollingBackedAccessReadinessItem
    {
        return new ManageRollingBackedAccessReadinessItem($key, $label, $status, $owner, $expectedValue, $note);
    }
}
