...
use App\Managing\ServiceInterface\Administration\ManageFieldViewProfileApplyServiceInterface;
 ...
 */
final readonly class ManageFieldViewProfileApplyService implements ManageFieldViewProfileApplyServiceInterface
{
    public function prepare(ManageFieldViewProfileApplyRequest $request): ManageFieldViewProfileApplyResult
    {
        ...
        if (null !== $contextError) {
            return ManageFieldViewProfileApplyResult::rejected($contextError);
        }

        $payloadError = $this->validateProfilePayload($request->normalizedProfilePayload);
        if (null !== $payloadError) {
            return ManageFieldViewProfileApplyResult::rejected($payloadError);
        }
        ...
        return ManageFieldViewProfileApplyResult::accepted([
